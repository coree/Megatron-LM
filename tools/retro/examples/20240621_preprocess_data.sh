...
WIK="/mnt/data/enwiki-latest-single-file/bert/my-bert_text_sentence"
...
BERT_EMB_CKPT="/mnt/data/checkpoints/megatron_bert_345m_v0.1_uncased"
BERT_EMB_VOCAB="/mnt/data/resources/bert-uncased-vocab.txt"


######## GPT. TOKENIZER MODEL ########

GPT_TOKENIZER_MODEL="/mnt/data/checkpoints/megatron_lm_345m_v0.0"
