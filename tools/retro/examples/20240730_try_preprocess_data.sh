...
#! Update
GPT_TOKENIZER_MODEL="/users/jcorneli/workspace/Megatron-LM/data/models/retro-8b-instruct-4k_1.0/mt_nlg_plus_multilingual_ja_zh_the_stack_frac_015_256k.model"
...
RETRO_GPT_TRAIN_SAMPLES=2000
RETRO_GPT_LR_DECAY_SAMPLES=1750
RETRO_GPT_LR_WARMUP_SAMPLES=100
...
RETRO_QUERY_NUM_NEIGHBORS_SAVE=2
RETRO_QUERY_EF_SEARCH=8
